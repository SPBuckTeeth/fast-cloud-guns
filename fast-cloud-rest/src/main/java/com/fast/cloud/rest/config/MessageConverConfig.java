package com.fast.cloud.rest.config;

import com.fast.cloud.rest.config.properties.RestProperties;
import com.fast.cloud.rest.modular.auth.converter.WithSignMessageConverter;
import com.fast.cloud.core.config.DefaultFastjsonConfig;

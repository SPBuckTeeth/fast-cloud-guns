package com.fast.cloud.generator.action.config;
...
public class GunsGeneratorConfig extends AbstractGeneratorConfig {
    ...
    protected void packageConfig() {
        ...
        packageConfig.setEntity("com.fast.cloud.admin.common.persistence.model");
        packageConfig.setMapper("com.fast.cloud.admin.common.persistence.dao");
        packageConfig.setXml("com.fast.cloud.common.persistence.dao.mapping");
    }

    protected void contextConfig() {
        contextConfig.setProPackage("com.fast.cloud.admin");
        contextConfig.setCoreBasePackage("com.fast.cloud.core");
